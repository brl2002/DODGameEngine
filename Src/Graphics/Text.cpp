...
Text::Text()
	:	m_Font(0),
		m_sentence1(0), m_sentence2(0), m_sentence3(0), m_sentence4(0), m_sentence5(0),
		m_sentence6(0), m_sentence7(0), m_sentence8(0), m_sentence9(0), m_sentence10(0)
{}
...
bool Text::Render(ID3D11DeviceContext* deviceContext, FontShader* FontShader, DirectX::XMMATRIX worldMatrix, DirectX::XMMATRIX orthoMatrix)
{
	bool result;
...
bool Text::RenderSentence(SentenceType* sentence, ID3D11DeviceContext* deviceContext, FontShader* FontShader, DirectX::XMMATRIX worldMatrix,
